...
def config_from_checkpoint(algo_name=None, ckpt_path=None, ckpt_dict=None, verbose=False):
    ...
    config_dict["observation"]["encoder"]["rgb"]["core_kwargs"]["backbone_kwargs"]["dummy"] = False
...
def policy_from_checkpoint(device=None, ckpt_path=None, ckpt_dict=None, verbose=False, camera_names=None):
    """
...
def env_from_checkpoint(ckpt_path=None, ckpt_dict=None, env_name=None, render=False, render_offscreen=False, verbose=False, camera_names=None):
    """
