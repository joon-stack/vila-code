...
class VisualCore(EncoderCore, BaseNets.ConvBase):
    ...
    def __init__(
        ...
        if pool_class is not None:
            ...
            # print(f"INFO: self.pool: {self.pool}")
            # assert isinstance(self.pool, BaseNets.Module)
            import robomimic.models.base_nets as b
            print(b.__file__)
            print(dir(b))
            print("INFO: self.pool.__class__.__module__: ", self.pool.__class__.__module__)
            print("INFO: __import__(self.pool.__class__.__module__).__file__: ", __import__(self.pool.__class__.__module__).__file__)
    ...
    def forward(self, inputs):
        ...
        # assert tuple(inputs.shape)[-ndim:] == tuple(self.input_shape), "inputs.shape: {}, self.input_shape: {}".format(inputs.shape, self.input_shape)
